import { computed, toRaw, defineComponent, mergeProps, unref, resolveComponent, defineAsyncComponent, h, getCurrentInstance, reactive, watch, Text, Comment, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderSlot } from 'vue/server-renderer';
import { ai as pascalCase, aj as kebabCase, ak as destr } from '../nitro/nitro.mjs';
...
const virtual_nuxt__2Fvercel_2Fsandbox_2Fprimary_2F_nuxt_2Fcontent_2Fcomponents = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  globalComponents,
  localComponents
    ...
    function resolveVueComponent(component) {
      ...
      if (typeof component === "string") {
        ...
        if (globalComponents.includes(pascalCase(component))) {
          ...
          const loader = () => {
            return Promise.resolve().then(() => virtual_nuxt__2Fvercel_2Fsandbox_2Fprimary_2F_nuxt_2Fcontent_2Fcomponents).then((m) => {
...
//# sourceMappingURL=ContentRenderer-CTwdfSYa.mjs.map
