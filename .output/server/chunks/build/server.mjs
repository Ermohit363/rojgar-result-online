...
const _routes = [
  {
    name: "404",
    path: "/404",
    component: () => import('./404-cUU62QQh.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./about-CrnZaNvG.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-D3WBbddX.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-D1BK99Cw.mjs')
  },
  {
    name: "disclaimer",
    path: "/disclaimer",
    component: () => import('./disclaimer-B81bHA9u.mjs')
  },
  {
    name: "post-slug",
    path: "/post/:slug()",
    component: () => import('./_slug_-DlsHIexz.mjs')
  },
  {
    name: "privacy-policy",
    path: "/privacy-policy",
    component: () => import('./privacy-policy-caCovXaM.mjs')
  },
  {
    name: "category-slug",
    path: "/category/:slug()",
    component: () => import('./_slug_-BWLTJV_k.mjs')
  },
  {
    name: "current-affair",
    path: "/current-affair",
    component: () => import('./index-iSlsQtow.mjs')
  },
  {
    name: "current-affair-slug",
    path: "/current-affair/:slug()",
    component: () => import('./_slug_-3-AhCdH8.mjs')
  }
];
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-BsScgqQy.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-CGJnyJrY.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-DY9TG5mi.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-CGwqNl-4.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-Kou6zRBf.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-BEqRWa8S.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-C7gvl8e6.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-CGBcQWsB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-DUS2qO9m.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-Dw5xWwvI.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-RBiW-pbB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-C6GPm8Fs.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-_Inf8uv9.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-h9-acCcQ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-D096MirS.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-nit7HbA4.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-C4AziPmO.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-V5d29xmK.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-CgP6uxbk.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-DDtqwkcN.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-B3IpOhYj.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-D94T56q6.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-Ba0Uz81f.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BCd_VcNi.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BWIMvBfm.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C2D092XF.mjs'));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-8rPzkNEP.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
...
export { _export_sfc as _, useRuntimeConfig as a, useRoute as b, createError as c, useRequestEvent as d, entry$1 as default, useNuxtApp as e, asyncDataDefaults as f, useRouter as g, nuxtLinkDefaults as h, injectHead as i, useOgImageRuntimeConfig as j, useSiteConfig as k, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useHead as u };
